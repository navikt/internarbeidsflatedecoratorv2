...
const NAVLogo = () => {
    return (
            <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                ...
                <g>
                    <path className="dekorator__navlogo_fill1" d="M115.2,47.8c0,25.4-20.6,46.1-46.1,46.1C43.7,93.9,23,73.3,23,47.8C23,22.4,43.7,1.7,69.1,1.7
        C94.6,1.7,115.2,22.4,115.2,47.8" />
                    <polygon className="dekorator__navlogo_fill1" points="0.7,67.9 10.2,44.6 19.2,44.6 9.8,67.9  " />
                    <polygon className="dekorator__navlogo_fill1" points="117,67.9 126.3,44.6 131.2,44.6 121.9,67.9  " />
                    <polygon className="dekorator__navlogo_fill1" points="135.3,67.9 144.6,44.6 147.2,44.6 137.9,67.9    " />
                    <path className="dekorator__navlogo_fill2" d="M108.4,44.6h-8.2c0,0-0.6,0-0.8,0.5L94.9,59l-4.5-13.9c-0.2-0.5-0.8-0.5-0.8-0.5H73.9c-0.3,0-0.6,0.3-0.6,0.6
